...
//let baseUrl = getUrl.protocol + "//" + getUrl.host + "//SigDAEM";
...
function Mensaje(msj) {
    swal({
        title: "Indicadores de Control Detenido",
        text: msj,
        imageUrl: "~/resources/Imagenes/LogoPN.jpg"
    });
...
function MensajeGuardado(msj) {
    ...
    swal('Indicadores de Control Detenido', msj, 'success')
};
...
async function save(Url, args) {
    ...
    try {
        result = await $.ajax({
            ...
            MensajeGuardado(response.mensaje);
        ...
        MensajeGuardado("No se pudo Guardar Correctamente");
    }
}
